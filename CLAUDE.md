...
This project is indexed by GitNexus as **metaplex-cli** (5340 symbols, 8528 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
