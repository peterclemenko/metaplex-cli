...
This project is indexed by GitNexus as **metaplex-cli** (5311 symbols, 8505 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
